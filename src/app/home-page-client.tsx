...
import { FuturisticAuthForm } from '@/components/auth/futuristic-auth-form';
...
function AuthModals() {
  ...
  React.useEffect(() => {
    ...
    return () => {
        window.removeEventListener('open-signup', openSignupEvent);
    }
  }, [searchParams]);
    ...
    <>
      <Dialog open={isLoginOpen} onOpenChange={setIsLoginOpen}>
        <DialogContent className="p-0 border-0 bg-transparent shadow-none">
            ...
            <FuturisticAuthForm type="login" onSwitch={onSwitchForms} />
        </DialogContent>
      </Dialog>
...
export function HomePageClient({ featuredOffers, phoneCardOffers }: { featuredOffers: any[], phoneCardOffers: any[] }) {

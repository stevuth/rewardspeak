...
export default function FraudDetectionPage() {
    const [suspiciousGroups, setSuspiciousGroups] = useState<SuspiciousIPGroup[]>([]);
    ...
    return (
        <div className="space-y-8">
            <PageHeader
                ...
                description="This tool identifies potential fraudulent activity, starting with users sharing IP addresses."
            />
            {suspiciousGroups.length > 0 ? (
                ...
                <Card>
                    <CardContent className="p-8 text-center">
                        <p className="text-muted-foreground">No suspicious IP address activity detected at this time.</p>
                    </CardContent>
                </Card>
            )}
        </div>

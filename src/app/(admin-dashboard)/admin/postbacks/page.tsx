            ...
            <Table className="min-w-[1200px]">
              <TableHeader>
                <TableRow>
                  ...
                  <TableHead>Rewarded Txn ID</TableHead>
                </TableRow>
              </TableHeader>
              <TableBody>
                {isLoading ? (
                  <TableRow>
                    <TableCell colSpan={9} className="text-center h-64">
                  ...
                  transactions.map((tx) => (
                    <TableRow key={tx.id}>
                      ...
                      <TableCell>
                          <Badge variant="destructive" className="font-mono">{tx.rewarded_txn_id || 'N/A'}</Badge>
                      </TableCell>
                    </TableRow>
                  ))
                ) : (

...
import { Gamepad2, CheckCircle, Gift, Users, Zap, Award } from "lucide-react";
      ...
      <main className="flex-1">
        <section className="relative py-24 md:py-32 bg-gradient-to-br from-primary/10 to-background">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <Award className="mx-auto h-20 w-20 text-primary animate-pulse mb-6" />
        ...
        <section id="how-it-works" className="py-20 md:py-28 bg-card">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center max-w-2xl mx-auto">
              <h2 className="text-3xl md:text-4xl font-bold mb-4">Your Adventure Starts Here</h2>
              <p className="text-muted-foreground mb-12">
                Earning with Rewards Peak is as easy as 1, 2, 3.
              </p>
            </div>
            <div className="grid md:grid-cols-3 gap-8 text-center">
              <div className="flex flex-col items-center p-6 rounded-lg transition-transform hover:scale-105 hover:bg-background">
                ...
                <h3 className="text-xl font-semibold mb-2">1. Accept a Quest</h3>
                <p className="text-muted-foreground">
                  Browse our board of quests from trusted partners.
                </p>
              </div>
              <div className="flex flex-col items-center p-6 rounded-lg transition-transform hover:scale-105 hover:bg-background">
                <div className="flex items-center justify-center h-16 w-16 rounded-full bg-primary/10 text-primary mb-4">
                ...
                <h3 className="text-xl font-semibold mb-2">2. Conquer It</h3>
                <p className="text-muted-foreground">
                  Follow the objectives to complete the quest or challenge.
                </p>
              </div>
              <div className="flex flex-col items-center p-6 rounded-lg transition-transform hover:scale-105 hover:bg-background">
                <div className="flex items-center justify-center h-16 w-16 rounded-full bg-primary/10 text-primary mb-4">
                ...
                <h3 className="text-xl font-semibold mb-2">3. Claim Your Loot</h3>
                <p className="text-muted-foreground">
                  Your points are instantly added to your treasury upon completion.
                </p>
              </div>
            </div>
          </div>
        ...
        <section id="features" className="py-20 md:py-28">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center max-w-2xl mx-auto">
              <h2 className="text-3xl md:text-4xl font-bold mb-4">Your Arsenal for Success</h2>
              <p className="text-muted-foreground mb-12">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              <Card className="hover:border-primary transition-colors">
                <CardHeader className="flex flex-row items-center gap-4">
                  ...
                  <CardTitle>Diverse Quests</CardTitle>
                </CardHeader>
                <CardContent>
              ...
              <Card className="hover:border-primary transition-colors">
                ...
                <CardContent>
                  Cash out your earnings through PayPal or cryptocurrency.
                </CardContent>
              </Card>
              <Card className="hover:border-primary transition-colors">
                <CardHeader className="flex flex-row items-center gap-4">
                  <Users className="h-8 w-8 text-primary" />
                  <CardTitle>Guild Program</CardTitle>
                </CardHeader>
                <CardContent>

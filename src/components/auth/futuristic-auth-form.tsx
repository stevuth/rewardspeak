...
const DancingMascotLoader = ({ messages, duration = 2500 }: { messages?: string[], duration?: number }) => {
    ...
    const displayText = messages && messages.length > 0 ? messages[index] : "Loading...";
        ...
        <div className="w-full h-full flex flex-col items-center justify-center overflow-hidden">
            ...
            <div className="relative h-6 w-full text-center mt-1">
                <AnimatePresence mode="wait">
                    <motion.p
                        key={displayText} // Key change triggers animation
    ...
    return (
        ...
        <AnimatePresence>
          {isPending ? (
            ...
            >
              <DancingMascotLoader messages={loadingMessages} />
            </motion.div>
          ) : (
            <motion.div
              key="ready"
